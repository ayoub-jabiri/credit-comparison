export default function CreditCard({ color, name, rising, interestRate }) {
    return (
        <div className="col-span-4">
            <div
                className="relative shadow-md h-37.5 p-4 rounded-md flex flex-col justify-between"
            ...
            >
                ...
                <img
                    src="/chip.png"
                    alt="Card Chip"
                    className="absolute top-[50%] right-4 translate-y-[-50%] w-[30px]"
                />
            </div>
